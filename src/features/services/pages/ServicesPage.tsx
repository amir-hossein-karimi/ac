...
export function ServicesPage() {
  const services = [
    ...
    },
    {
      ...
      description:
        "Optimize and manage your databases for peak performance and reliability.",
      features: [
        "Performance Tuning",
        "Data Migration",
        "Backup Solutions",
  ...
  const faqs = [
    {
      ...
      answer:
        "We use cutting-edge technologies including React, TypeScript, Node.js, Python, and various cloud platforms like AWS and Azure. Our tech stack is always evolving to include the latest and most reliable tools.",
    },
    {
      question: "How long does a typical project take?",
      answer:
        "Project timelines vary based on scope and complexity. A simple website might take 2-4 weeks, while a complex application could take 3-6 months. We provide detailed timelines during the initial consultation.",
    },
    {
      question: "Do you provide ongoing support?",
      answer:
        "Yes! We offer various support packages including maintenance, updates, monitoring, and technical support. Our team is available 24/7 for enterprise clients.",
    },
    {
      question: "Can you work with our existing systems?",
      answer:
        "Absolutely. We specialize in integrating with existing systems and can work with virtually any platform or technology stack. We'll assess your current setup and create a seamless integration plan.",
    },
    {
      question: "What is your development process?",
      answer:
        "We follow an agile methodology with regular sprints, continuous integration, and frequent client communication. You'll have full visibility into the development process with regular demos and updates.",
    },
    {
      question: "Do you offer custom solutions?",
      answer:
        "Yes, all our services can be customized to meet your specific needs. We pride ourselves on creating tailored solutions that align perfectly with your business objectives.",
    },
  ];
            ...
            {services.map((service, index) => {
              ...
              return (
                ...
                >
                  <CardHeader>
                    <div
                      className={`h-14 w-14 ${service.color} rounded-lg flex items-center justify-center mb-4`}
                    >
          ...
          <Tabs defaultValue="discovery" className="w-full">
            ...
            <TabsContent value="design" className="space-y-4">
              <Card>
                ...
                <CardContent>
                  <p className="mb-4">
                    Our design team creates beautiful, user-friendly interfaces
            ...
            <TabsContent value="development" className="space-y-4">
              <Card>
                ...
                <CardContent>
                  <p className="mb-4">
                    Our developers bring designs to life with clean,
                    maintainable code.
                  </p>
                  <ul className="space-y-2">
                    <li className="flex items-start gap-2">
